/*
 * Smart Door Security System (v4 - for Separate Backend)
 *
 * This version uses dedicated MQTT topics (security/door/...) to ensure
 * it does not conflict with any other smart home systems.
 */
...
// --- DEDICATED MQTT TOPICS FOR THE SECURITY DOOR ---
...
void reconnect() {
  while (!client.connected()) {
    ...
    String clientId = "ESP32-SecurityDoor-"; // Unique client ID
